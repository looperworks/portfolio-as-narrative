...
const DIAGRAM_MAP = {
  ...
  2: [
    ...
    { image: "class-pdf/casestudy-spread-2.jpg", title: "Spread 2 — Site Context + Architectural Incision", alt: "Aerial site photograph of alpine landscape paired with detail terrain model showing ramped cut into slope" },
    { image: "class-pdf/casestudy-spread-3.jpg", title: "Spread 3 — Winter Renderings + Section", alt: "Winter approach rendering, night entry rendering as glowing slit in terrain, and full building section below grade" },
    { image: "class-pdf/casestudy-spread-4.jpg", title: "Spread 4 — Model + Approach + Section", alt: "Roof emerging as geometric cut in snow, visitors on ramped descent, and second building section" },
    { image: "class-pdf/casestudy-spread-5.jpg", title: "Spread 5 — Gallery Interiors + Floor Plans", alt: "Interior gallery renderings showing visitors in exhibition spaces, with first and second floor plans" },
  ],
  3: [
